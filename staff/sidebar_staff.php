    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="role_staff.php">Role</a></li>
            <li class="nav-item"> <a class="nav-link" href="user_staff.php">User</a></li>
          </ul>
        </div>
      </li>
  
      <li class="nav-item menu-items">
        <a class="nav-link" href="slide_staff.php">
          <span class="menu-icon">
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="category_staff.php">Category</a></li>
            <li class="nav-item"> <a class="nav-link" href="menu_staff.php">Menu</a></li>
          </ul>
        </div>
      </li>
    </ul>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
              <div class="navbar-profile">
                ...
                <p class="mb-0 d-none d-sm-block navbar-profile-name">Staff</p>
