          ...
          <div class="card-body">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="caption" name="menu" required value="<?php echo $result2['nm_menu'] ?>">
                </div>
  
                <div class="mb-3">
                    <label for="price" class="form-label">Price</label>
                    <input type="number" class="form-control" id="caption" name="price" required value="<?php echo $result2['price'] ?>">
                </div>
...
if(isset($_POST['submit'])){
    ...
    $query2 = mysqli_query($koneksi, "UPDATE menu set
    ...
    if($query2){
        echo "<script>
            alert('Edit menu berhasil, menunggu persetujuan !');
            document.location='menu_staff.php';
            </script>";
    }
    else {
        echo "<script>
            alert('Maaf, terjadi kesalahan saat mencoba edit menu !');
            document.location='menu_staff.php';
            </script>";
    }
  }
